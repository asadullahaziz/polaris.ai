...
# v1 = qualify-and-hold. propose/counter/accept are STRETCH (structured negotiation).
...
class ResponderState(TypedDict, total=False):
    ...
    tool_results: dict  # assessment / valuation / comps
    ...
    outcome: str | None  # sent | draft | escalated | stood_down_* | duplicate
